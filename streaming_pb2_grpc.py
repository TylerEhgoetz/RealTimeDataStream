...
class TickServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamTicks = channel.unary_stream(
            "/streaming.TickService/StreamTicks",
            request_serializer=streaming__pb2.Empty.SerializeToString,
            response_deserializer=streaming__pb2.Tick.FromString,
...
def add_TickServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "StreamTicks": grpc.unary_stream_rpc_method_handler(
            ...
            response_serializer=streaming__pb2.Tick.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        "streaming.TickService", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("streaming.TickService", rpc_method_handlers)
...
class TickService(object):
    ...
    def StreamTicks(
        ...
        return grpc.experimental.unary_stream(
            ...
            streaming__pb2.Tick.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
